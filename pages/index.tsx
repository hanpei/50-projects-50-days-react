    ...
    <div className="min-h-screen py-2">
      ...
      <main className="flex w-full flex-1 flex-col items-center justify-center px-20 text-center">
        ...
        <div className="grid w-full grid-cols-4 gap-4">
          ...
          <Project name="blurry-loading" idx={5}></Project>
        </div>
      </main>
    </div>
  )
...
function Project({ name, idx }: IProjectProps) {
  ...
  return (
    <Link href={`/projects/${name}`}>
      <div className="relative flex cursor-pointer flex-col items-center justify-center overflow-hidden border-2 border-gray-200 transition-colors duration-500 hover:border-pink-500">
        ...
        <img
          src={`img/${name}.jpg`}
          alt=""
          className="z-10 w-[400px] object-contain"
        />

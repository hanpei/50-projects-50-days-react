    ...
    <Layout title="rotating-nav">
      <RotatingContainer nav={navItems}>
        <div className="container mx-auto max-w-3xl text-lg">
          ...
          <p className="py-5">
            Voluptatibus iure eaque cupiditate quo autem quos aliquam atque.
            Enim qui et autem vel ut eaque quia et quia. Sunt dolor ut pariatur
          ...
          <p className="py-5">
            ...
            aperiam autem nihil adipisci et voluptatem ipsam. Sed ut sunt
            numquam. Quibusdam fuga dolore ex quo dolorum quod cupiditate eos
            omnis. Quia placeat sequi qui natus aut similique et. Sint quo fugit
            exercitationem atque rerum ut. Consequatur doloremque vero mollitia
            omnis aperiam quia itaque. Sed eos dolor ut voluptas qui id enim
            illo. Fuga omnis impedit quisquam quasi laudantium et ipsum. Iure
            voluptas voluptatem rerum voluptatem. Cupiditate excepturi nihil
            nemo rem facilis eveniet. Ea atque rem adipisci ut ea. Quasi tenetur
            omnis aut. Eligendi vero quidem sed neque.
          </p>
        </div>
      </RotatingContainer>
    </Layout>
